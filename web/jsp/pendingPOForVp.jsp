    ...
    if (winl < 0) winl = 0;
    if (wint < 0) wint = 0;
    var page = "PurchaseOrder.action?redirectPopupVp=&id="+${actionBean.id}+"";
   ...
   <br>
    ...
    <s:link beanclass="com.erp.action.PurchaseOrderActionBean" event="viewForVp" onclick="return lm_confirm();" >
