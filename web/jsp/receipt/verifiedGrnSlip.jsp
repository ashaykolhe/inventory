...
<s:useActionBean beanclass="com.erp.action.GrnActionBean" var="listofgrn" event="makePayment"></s:useActionBean>
...
<table width="760px" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
       ...
       <td align="center"> 
           <s:submit name="success" value="Approve" onclick="return reloadParentAndClose();"></s:submit> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
